      ...
      <div class="content-box">
        ...
        <div class="col-main ofHD psR">
          ...
          <div class="main-box mgT20 pdT10 mgTB15_" >
              ...
              <form action="edit?act=edit" method="post" id="mainForm" name="mainForm"  class="pdB40 mgTB15_ " enctype="multipart/form-data">
	            ...
	            <div class="clearfix flL_">
	                ...
	                <div class="col_5">
	                  <div class="img-box1 curP" onclick="document.getElementById('bannerPath').click();">
                  		...
                  		<p class="cle5e5e5 txtC">建议尺寸 400x400</p>
                 ...
                 <div class="clearfix flL_">
                  ...
                  <div class="col_5">
                   <c:if test="${manager.managerId==session_backend.managerId }">
                      <select name="roleId" class="form-control" disabled>
                   </c:if>
                   <c:if test="${manager.managerId!=session_backend.managerId }">
                 ...
                 <div class="clearfix flL_">
                  ...
                  <div class="col_5">
                      <input type="text" datatype="s3-20" nullmsg="请输入登录账号！" disabled="disabled" value="${manager.account }"  errormsg="登录账号不能小于3个字符或大于20个字符" style="ime-mode:disabled;"  maxlength="20"  class="form-control" name="account" id="account" value="${param.account}" placeholder="请输入您的登录账号">
                  </div>
                </div>
                 <div class="clearfix flL_">
