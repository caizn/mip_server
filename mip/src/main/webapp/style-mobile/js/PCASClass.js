...
function PCAS() {
	...
	if(arguments[0] && arguments[0].charAt(0)=='#'){
		this.SelP = document.getElementById(arguments[0].substring(1));
	}else{
		this.SelP = document.getElementsByName(arguments[0])[0];
	}
	if(arguments[1] && arguments[1].charAt(0)=='#'){
		this.SelC = document.getElementById(arguments[1].substring(1));
	}else{
		this.SelC = document.getElementsByName(arguments[1])[0];
	}
	if(arguments[2] && arguments[2].charAt(0)=='#'){
		this.SelA = document.getElementById(arguments[2].substring(1));
	}else{
