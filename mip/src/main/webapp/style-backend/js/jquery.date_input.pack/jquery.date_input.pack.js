	...
	DateInput.prototype = {
		...
		hideIfClickOutside: function(event) {
			...
			if ( event.target != this.input[0] && !this.insideSelector(event)) {
				var clas = event.target.getAttribute('class');
				if(clas.indexOf('prev') != -1 || clas.indexOf('next') != -1){
				...
				/*
				console.log('-----');
				console.log(clas.indexOf('prev'));
				console.log(clas.indexOf('next'));
				*/
			}
		},
